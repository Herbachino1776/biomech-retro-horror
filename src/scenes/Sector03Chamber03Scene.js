...
const ENEMIES = {
  ...
  sealedArchetype: {
    ...
    presentation: { alpha: 0.98, display: { width: 236, height: 192 }, origin: { x: 0.52, y: 0.95 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.44 } },
    corpseRemainsProfile: 'sector3Basic'
  },
  elite: {
    ...SKITTER,
    ...
    presentation: { alpha: 0.98, display: { width: 366, height: 286 }, origin: { x: 0.52, y: 0.93 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.46 } },
