...
const ENEMIES = {
  veil: {
    ...
    presentation: { alpha: 0.98, display: { width: 222, height: 186 }, origin: { x: 0.52, y: 0.946 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.44 } },
    corpseRemainsProfile: 'sector3Basic'
  },
  husk: {
    ...SKITTER,
    textureKey: ASSET_KEYS.sector03Chamber02EnemyBasicMaskHusk,
    presentation: { alpha: 0.98, display: { width: 224, height: 186 }, origin: { x: 0.52, y: 0.946 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.44 } },
    corpseRemainsProfile: 'sector3Basic'
  },
  cantor: {
    ...SKITTER,
    textureKey: ASSET_KEYS.sector03Chamber02EnemyBasicBlindCantor,
    presentation: { alpha: 0.98, display: { width: 226, height: 188 }, origin: { x: 0.52, y: 0.946 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.44 } },
    corpseRemainsProfile: 'sector3Basic'
  },
  collector: {
    ...SKITTER,
    textureKey: ASSET_KEYS.sector03Chamber02EnemyBasicFaceCollector,
    presentation: { alpha: 0.98, display: { width: 232, height: 192 }, origin: { x: 0.52, y: 0.946 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.44 } },
    corpseRemainsProfile: 'sector3Basic'
  },
  elite: {
    ...SKITTER,
    ...
    presentation: { alpha: 0.98, display: { width: 346, height: 268 }, origin: { x: 0.52, y: 0.94 }, stateAlpha: { windup: 1, attack: 1, hurt: 1, dead: 0.46 } },
