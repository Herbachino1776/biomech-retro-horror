...
export const chamber02BossPitHollowSkyConfig = {
  encounterId: 'chamber02-bosspit-hollow-sky',
  rewardGrantId: 'chamber02-bosspit-03-hollow-sky-witness',
  bootstrap,
  returnFlow: {
  ...
  altars: {
    ...
    altarImageKey: ASSET_KEYS.bossPit01AltarTrap,
    returnAltarImageKey: ASSET_KEYS.bossPit01AltarSuper,
    altarImageFallbackKey: ASSET_KEYS.bossPit01AltarTrap,
    interaction: { zoneWidth: 196, zoneHeight: 212, promptOffsetY: -170, inactivePrompt: '', activePrompt: '' }
  },
  visuals: {
    backgroundImageKey: ASSET_KEYS.bossPit03BackgroundHollowSkyTheatre,
    backgroundY: 210,
  ...
  runState: {
    markCompleted: () => bossPitRunState.markChamber02HollowSkyBossPitCompleted(),
    hasRewardGranted: () => bossPitRunState.hasChamber02HollowSkyBossPitRewardGranted(),
    markRewardGranted: () => bossPitRunState.markChamber02HollowSkyBossPitRewardGranted()
  }
};
